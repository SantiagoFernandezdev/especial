...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["HojadeVida-hoja-hoja-module"], {
  ...
  /***/
  function srcAppPagesHojadeVidaHojaHojaRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesHojadeVidaHojaHojaModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesHojadeVidaHojaHojaPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function HojaPage_ion_list_10_ion_item_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HojaPage_ion_list_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HojaPage_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HojaPage_ion_list_12_ion_item_1_ion_label_3_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var hoja_r599 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", hoja_r599.idtaller.nombrecompleto, "");

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", hoja_r599.idusuario.nombrecompleto, "");

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("tiene ", hoja_r599.repuestos.length, "");

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("tiene ", hoja_r599.trabajos.length, "");

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](6);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](25, 5, hoja_r599.fecha));
      }
    }

    function HojaPage_ion_list_12_ion_item_1_ion_label_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-label", 25);
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", hoja_r599.nusuario, "");
    ...
    function HojaPage_ion_list_12_ion_item_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HojaPage_ion_list_12_ion_item_1_Template_ion_item_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r605);

          var hoja_r599 = ctx.$implicit;

          var ctx_r604 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r604.navegar(hoja_r599);
        });
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", !hoja_r599.tipo || hoja_r599.tipo === "cita");

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", hoja_r599.tipo && hoja_r599.tipo === "hoja");
      }
    }

    function HojaPage_ion_list_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-list");
      ...
      if (rf & 2) {
        var ctx_r594 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx_r594.hojas);
      }
    }

    function HojaPage_ion_infinite_scroll_13_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionInfinite", function HojaPage_ion_infinite_scroll_13_Template_ion_infinite_scroll_ionInfinite_0_listener($event) {
          ...
          return ctx_r607.loadData($event);
        });
    ...
    /*#__PURE__*/
    function () {
      function HojaPage(almacenamiento, toast, apiHoja, router, statusbar, alertCtrl) {
      ...
      _createClass(HojaPage, [{
        ...
        value: function refrescando(event) {
          this.desde = 0;
          this.cargarHojas().then(function () {
                ...
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    if (info) {
                      ...
                      this.apiHoja.buscarHojas(info.token, {
                        desde: this.desde
                      }).subscribe(function (data) {
                        console.log(data);

                        if (data.exe) {
                          _this.hojas = data.response;
                        } else {
                          _this.hojas = [];

                          _this.toast.toastError('No se pudo traer las hojas de vida, inténtelo más tarde.');
                        }
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 5:
                    ...
                    if (info) {
                      this.apiHoja.buscarHojasFiltro(info.token, {
                        desde: this.desde,
                        patron: this.patron
                      }).subscribe(function (data) {
                        ...
                        if (data.exe) {
                          _this2.hojas = data.response;
                        } else {
                          _this2.toast.toastError('No se pudo realizar la búsqueda, intentelo más tarde');
                        }
                      }, function (err) {
                        _this2.toast.toastError('No se pudo realizar la búsqueda, intentelo más tarde');
                      });
                      ...
                      if (this.patron === '') {
                        this.apiHoja.buscarHojas(info.token, {
                          ...
                          if (data.exe) {
                            ...
                            _this3.toast.toastError('No se pudo traer las hojas de vida, inténtelo más tarde.');
                          }
                        }, function (err) {
                          _this3.toast.toastError('No se pudo traer las hojas de vida, inténtelo más tarde.');
                        });
                ...
                switch (_context5.prev = _context5.next) {
                  ...
                  case 2:
                    ...
                    if (info) {
                      ...
                      this.apiHoja.crearHoja(info.token, {
                        usuario: '',
                        placa: data.placa,
                        nusuario: data.cliente,
                        cita: ''
                      }).subscribe(function (resp) {
                        console.log(resp);

                        if (resp.exe) {
                          _this5.toast.toastExitoso('Hoja de vida creada');
                        } else {
                          _this5.toast.toastError('No se pudo crear la hoja de vida, intentelo más tarde');
                        }
                      }, function (err) {
                        _this5.toast.toastError('No se pudo crear la hoja de vida, intentelo más tarde');
                      });
    ...
    HojaPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: HojaPage,
      selectors: [["app-hoja"]],
      viewQuery: function HojaPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function HojaPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionRefresh", function HojaPage_Template_ion_refresher_ionRefresh_6_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionChange", function HojaPage_Template_ion_searchbar_ionChange_8_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HojaPage_Template_ion_fab_button_click_15_listener() {
            return ctx.abrir();
          });
...
//# sourceMappingURL=HojadeVida-hoja-hoja-module-es5.js.map